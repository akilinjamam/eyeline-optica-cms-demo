...
import useWishlistContactLensList from "./useWishlistContactLens";

const WishlistContactLens = () => {

  const {columns, setSearch, search,  filterSummary, paginatedData, setPaginatedData,  filters, page, setPage, filteredDataa, isLoading, showCheck} = useWishlistContactLensList();
  ...
  // PDF hook
  const { handleDownloadPDF } = usePdfDownloader(tableData, header, "Wishlist-Contact-Lens-List");
...
export default WishlistContactLens;
