...
import useLensOrder from "./useLensOrder";
...
import type { ILensSaleInfo } from "../../../../types/interface";
...
const LensOrder = () => {
        ...
        const defaultColumn = columns?.slice(0,8)
         ...
         // Table data
         const tableData = filteredData.map((clens: ILensSaleInfo) =>
           dynamicColumns.map(item => clens[item.key as keyof ILensSaleInfo])
         );
