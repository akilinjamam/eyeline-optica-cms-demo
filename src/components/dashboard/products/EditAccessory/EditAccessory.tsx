...
import { useEditAccessory } from "./useEditAccessory";
import type { RootState } from "../../../../app/store";

export default function EditAccessory() {

     const {editableData} = useSelector((state:RootState) => state.modal)
  // ✅ Get selected accessory data from Redux selector
  const accessoryData = editableData
  ...
  const {
    ...
    handleImageUpload,
    removeImage,
  } = useEditAccessory(accessoryData);
        ...
        <CardContent>
          ...
          >
            ...
            <div>
              ...
              <Select
                defaultValue={accessoryData?.type || "others"}
              ...
              {fields.map((field, index) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <Input
                      type="number"
                      {...register(`items.${index}.salesPrice`, {
                        valueAsNumber: true,
                      })}
                      defaultValue={field.salesPrice}
                      placeholder="0"
                    />
                  </div>
