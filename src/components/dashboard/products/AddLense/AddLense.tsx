...
const AddLens = () => {
  const {
    availableCoatings,previewImages, register, handleSubmit,  handleImageUpload, removeImage, toggleCoating,onSubmit, watch, control,isLoading
  } = useAddLens();
      ...
      >
        ...
        >
          ...
          <div className="mt-6">
            ...
            >
              {isLoading ? '' : <Plus />} {isLoading ? 'Adding' : 'Add Lens'}
            </Button>
          </div>
        </form>
      </motion.div>
