...
const routeTitles: Record<string, string> = {
  ...
  "/dashboard/add_banner": "Add Banner",
  "/dashboard/manage_banner_list": "Manage Banner",
  ...
  "/dashboard/weeklyDeals": "Weekly Deals",
  "/dashboard/edit_weeklyDeals": "Manage Deals",
  "/dashboard/wishlist": "Wish List",
  "/dashboard/wishlist_frame": "Wish List Frame",
  "/dashboard/wishlist_lens": "Wish List Lens",
  "/dashboard/wishlist_contactLens": "Wish List Contact Lens",
  "/dashboard/add_blog": "Add Blog",
  "/dashboard/blog": "Blog",
  "/dashboard/blog_list": "Blog List",
  "/settings": "Settings",
  "/sales": "Sales",
  "/products": "Products",
};
