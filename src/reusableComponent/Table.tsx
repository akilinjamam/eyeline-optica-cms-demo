...
import type { ContactLens, Frame, IFrameSaleInfo, ILens, ITableInfo } from "../types/interface";
...
const Table = ({ paginatedData, column, actionColumn=[], showCheck }: ITableInfo<ContactLens | ILens | Frame | TRegistration | TCustomer | IFrameSaleInfo>) => {
